...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_INTENT_ID = 3414;
    private static final int ACTION_DRINK_INTENT_ID = 4332;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent pending = PendingIntent.getActivity(context, ACTION_IGNORE_INTENT_ID
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,
                context.getString(R.string.dismiss_msg), pending);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pending = PendingIntent.getActivity(context, ACTION_DRINK_INTENT_ID
                , intent, PendingIntent.FLAG_UPDATE_CURRENT);
        //      (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,
                context.getString(R.string.water_chug_toast), pending);
